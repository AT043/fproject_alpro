...
int main() {
				...
				system("cls");
					...
					if(selectA==1) {
						...
						if(tgl%2!=0) {
							...
							cout<<"Waktu tempuh dan lama perjalanan: "<<pesanTiket.waktuPergi[0]<<"-"<<pesanTiket.waktuSampai[0]<<" (7 Jam) "<<endl;
							...
							cout<<"Waktu tempuh dan lama perjalanan: "<<pesanTiket.waktuPergi[1]<<"-"<<pesanTiket.waktuSampai[1]<<" (7 Jam) "<<endl;
						...
						int tkt;
							...
							if(tkt==1) {
								...
								cin.ignore(); getline(cin, pesanTiket.dataTiket.nama);
								cout<<"Masukkan No Identitas Anda: "; cin>>pesanTiket.dataTiket.noIdentitas;
								cout<<"Masukkan email Anda: "; cin>>pesanTiket.dataTiket.email;
								cout<<"Masukkan jumlah tiket: "; cin>>pesanTiket.dataTiket.jumlahTiket;
								cout<<endl;
							...
							headerBar();
								...
								if(tgl%2!=0) {
									cout<<"Nama: "<<pesanTiket.dataTiket.nama<<endl;
									cout<<"email: "<<pesanTiket.dataTiket.email<<endl;
						...
						if(tgl%2==0) {
							...
							cout<<"Waktu tempuh dan lama perjalanan: "<<pesanTiket.waktuPergi[2]<<"-"<<pesanTiket.waktuSampai[2]<<" (5 Jam) "<<endl;
						...
						if(tgl%2!=0) {
							...
							cout<<"Waktu tempuh dan lama perjalanan: "<<pesanTiket.waktuPergi[3]<<"-"<<pesanTiket.waktuSampai[3]<<" (5 Jam) "<<endl;
							...
							cout<<"Waktu tempuh dan lama perjalanan: "<<pesanTiket.waktuPergi[4]<<"-"<<pesanTiket.waktuSampai[4]<<" (5 Jam) "<<endl;
			...
			case 2 :
				...
				system("cls");
					...
					if(tgl%2!=0) {
							...
							cout<<"Jadwal keberangkatan: "<<pesanTiket.tglBrkt[tgl-1]<<"-"<<pesanTiket.bulan[bln-1]<<pesanTiket.tahun<<endl;
							cout<<"Kapasitas kereta: "<<pesanTiket.kapasitas[2]<<endl;
							cout<<"Waktu tempuh dan lama perjalanan: "<<pesanTiket.waktuPergi[2]<<"-"<<pesanTiket.waktuSampai[2]<<" (7 Jam) "<<endl;
							cout<<"Harga tiket: Rp"<<pesanTiket.dataTiket.hargaTiket[2]<<endl;
							cout<<endl;
						} else if(tgl%2==0) {
							cout<<"Mohon maaf kereta belum tersedia :("<<endl;
	...
	/* 
	* Menu Informasi jadwal Keretanya 
	*/
			...
			int bln;
			int tgln;
			cout<<"Lihat jadwal kereta untuk bulan (masukkan dalam angka!): "; cin>>bln;
			if ((bln<=7) && (bln%2!=0) || (bln>=8) && (bln%2==0)) {
				tgln=31;
			} else if(bln==2) {
				tgln=28;
			} else {
			...
			cout<<"Jadwal kereta bulan "<<pesanTiket.bulan[bln-1]<<endl;
			cout<<"\n";
			for (int j=0; j<tgln; j++) {
				for (int i=0; i<5; i++) {
					
				if(j%2==0) {
				cout<<" Nama KA: "<< pesanTiket.namaKa[i] <<endl;
				cout<<" Asal: "<<pesanTiket.tujuanPulang[i] <<" Tujuan: "<<pesanTiket.tujuanPergi[i]<<endl;
				cout<<" Tanggal keberangkatan: "<<pesanTiket.tglBrkt[j]<<"-"<<pesanTiket.bulan[bln-1]<<"-"<<pesanTiket.tahun<<endl;
		...
		*/
			...
			cout<<"Masukkan Anda salah! Silahkan pilih sesuai angka yang ada di layar!"<<endl;
			back = true;
			system("cls");
		}
	} while(back = true);
